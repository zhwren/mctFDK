...
int main(int argc, char* argv[])
{
	...
	FILE *fp = fopen("/home/zhwren/Workfs/CTRecons/Datas/20160613/Dark/Dark.bin","rb");
	fread(pDarkImg,sizeof(float),scannerGeometry.m_DetectorColumnCount*scannerGeometry.m_DetectorRowCount,fp);
	fclose(fp);

	fp = fopen("/home/zhwren/Workfs/CTRecons/Datas/20160613/Air/AirScan.bin","rb");
	...
	fp = fopen("/home/zhwren/Workfs/CTRecons/Datas/20160613/Scan/ScanData.bin","rb");
