...
int main(int argc, char* argv[])
{
	...
	FILE *fp = fopen("/home/zhwren/Workfs/CTRecons/Datas/20160612/Dark/Dark.bin","rb");
	fread(pDarkImg,sizeof(float),scannerGeometry.m_DetectorColumnCount*scannerGeometry.m_DetectorRowCount,fp);
	fclose(fp);

	fp = fopen("/home/zhwren/Workfs/CTRecons/Datas/20160612/Air/AirScan.bin","rb");
	...
	fp = fopen("/home/zhwren/Workfs/CTRecons/Datas/20160612/Data/ScanData.bin","rb");
